...
> 注意，由于 TCP 链接是全双工的，所以会有 FIN_WAIT_1 和 FIN_WAIT_2 两个 FIN_WAIT 状态， FIN_WAIT_1 是主动关闭发送通道，等待对方确认，FIN_WAIT__2 是等待对方关闭发送通道，接收到对方发送的 FIN 后进入 TIMED_WAIT 状态，需要持续一段时间，是因为对端接收 ACK 需要时间
